...
```
Building a new snapshot may take some time so it might be necessary to increase Gradle timeouts ([FAQ](https://docs.jitpack.io/faq/)).
...
Also see the [Guide to building](https://docs.jitpack.io/building/) for more details and instructions on building multi-module projects.
...
See the [FAQ page](https://docs.jitpack.io/faq/)
